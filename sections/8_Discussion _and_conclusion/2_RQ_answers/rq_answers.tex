...
\begin{center}
\textbf{RQ1: How can we create better porous structures, manufacturable by 3D Printing micro-extrusion, for tissue engineering, in a physics-driven way?}
\end{center}
...
\begin{center}
\textbf{RQ2: Is it possible to generate bio-inspired structures that can be used in a real space scenario?}
\end{center}
...
\begin{center}
\textbf{RQ3: Is it possible to 3D-print self-supported structures in a
non-planar way?}
\end{center}
