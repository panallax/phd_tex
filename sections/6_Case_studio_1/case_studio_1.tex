...
The first objective of this work is to generate non-regular bone scaffolds that can be printed without support material, have a controllable pore size, and can be printed using FDM. 
The methodology developed allows for generating the skeleton of graph-based structures that meet the desired conditions.
...
Therefore, this chapter will explain how each objective was achieved and the challenges it presented. 
Lastly, the results obtained and the conclusions drawn during the process will be discussed.



\section{Generation of non-planar printing trajectories}
\subfile{1_Nonplanar_gcode/nonplanar_gcode}

\section{Adaptations of the 3D printer}
\subfile{2_3d_printer_modification/3d_printer_modification}

\section{Experimental evaluation of non-planar printing}
