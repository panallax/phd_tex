...
This section will outline the various extruders used and describe how they were adapted for operation.

\subsection{Extrusion nozzle design}
...
This extruder is screwed onto a block made of heat-conductive material, featuring an internal resistive heater and a thermistor or thermocouple for precise temperature control.

\begin{figure}[!htbp]
    \centering
    \includegraphics[width =0.7\textwidth]{imgs/nozzle.pdf}
...
It is clear that the extruder cannot be used to print the structures proposed in this study. An extruder with enhanced penetration capabilities is necessary.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width =0.7\textwidth]{imgs/nozzle2.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width =0.8\textwidth]{imgs/adapter.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width =0.5\textwidth]{imgs/needle.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width =\textwidth]{imgs/joint_1.pdf}
...
\subsection{Extrusion needle heating system}
...
\subsection{Assembly and integration of the heating system}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width =0.4\textwidth]{imgs/nozzle_mounting.pdf}
