...
From these, they calculate the intersection between the initial geometry and the Voronoi cells and thus obtain the filling of the initial structure,\textbf{ as shown in Figure 3.}
...
Alsheghri et al. \cite{VLAD2020110658}, Vlad et al. \cite{ALSHEGHRI2021112010}, and Gómez et al. \cite{GOMEZ2016341} base the location of the seed points on information extracted from bone by micro-computed tomography (µCT). 

Other authors use µCT to generate porous structures from other structures. 
The methodology used is the same in all articles and consists of scanning a porous structure by µCT to obtain its 3D CAD model.
...
Although advanced computational methods have emerged, such as stochastic topological optimisation, evolutionary algorithms, and machine learning-assisted generative design, which seek to balance biological realism and desired mechanical properties \cite{7829422, SIEGKAS2022110858, ZHANG20253684}. 
