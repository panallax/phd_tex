...
This section proposes a modification of the methodology mentioned above with the intention of reducing the density of points and ensuring all connections.
Starting from points distributed at the base of the volume, points are generated at a suitable distance and location from which new ones are generated. 
...
\cref{fig:esperanza} shows the variation in the expected values as a function of radius isnide a 3x4 \textit{mm} cylinder.
...
\begin{figure}
    ...
    \caption{Variation of expected values as a function of the chosen radius, r.}
    \label{fig:esperanza}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{imgs/color_nodes.pdf}
    \caption{Connectivity of the example structure. Each node is coloured according to its connectivity, following the colormap shown next to the nodal connectivity distribution.}
    \label{fig:color_nodes}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{imgs/lengths.pdf}
    \caption{Edge length dispersion in the example structure. Each edge is coloured according to its length, following the colormap shown next to the length distribution.}
    \label{fig:lengths}
\end{figure}
