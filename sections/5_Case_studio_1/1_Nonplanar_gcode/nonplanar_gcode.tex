...
However, in any case, both parameters are constant, so it is only necessary to know the length of the cylinder to be printed in order to obtain the E parameter. 
...
Therefore, the paths should traverse ascending and then descending edges in order to print the structure continuously. 
...
This way, each of the edges is printed in ascending order. 
