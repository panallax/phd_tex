...
\subsection{Nozzle temperature measurement}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/setup1.svg.pdf}
        \caption{Setup to measure the lateral temperature of the needle.}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/setup2.svg.pdf}
...
\subsection{Electrical parameters characterisation}
...
\subsection{First test: planar printing}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.5\textwidth]{imgs/04A.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.5\textwidth]{imgs/100vel_05A_vent0.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.5\textwidth]{imgs/50vel_05A_vent0.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.5\textwidth]{imgs/50vel_06A.svg.pdf}
    \caption{Cube printing test result with 0.6\textit{A} current and a printing speed of 25 \textit{mm/s}.}
    \label{fig:06A}
\end{figure}

In order to cool the polymer, a 3\textit{W} fan was installed next to the extruder to blow air directly onto the part. 
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.5\textwidth]{imgs/50vel_07A.svg.pdf}
    \caption{Cube printing test result with 0.6\textit{A} current and a printing speed of 25 \textit{mm/s}.}
    \label{fig:07A}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/50vel_07A_80FR.svg.pdf}
        \caption{Flow rate = 80\%.}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/50vel_07A_07FR.svg.pdf}
...
\subsection{Printing parameters characterisation}
...
\begin{figure}[!htbp]
    ...
    \caption{Inclined column printed during the temperature test.}
    \label{fig:temp_test}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.35\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/0_5R.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/10_15R.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/20_25R.svg.pdf}
...
Once the parameters to be used during printing had been decided, non-planar printing tests were carried out to learn about the challenges that may arise and need to be resolved in order to perform this type of printing. 
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width =0.6\textwidth]{imgs/P1_no_bed.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.465\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/stringing_detail_1.svg.pdf}
        \caption{Detail of strings glued and melted on the tip.}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.36\textwidth}
        \centering
        \\includegraphics[width = \textwidth]{imgs/detalle_aguja_tocando_2.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \\includegraphics[width = \textwidth]{imgs/puntas_abiertas.svg.pdf}
...
In the example, this point is $x_2'$ and is obtained using the expression included in the example. 
...
The purpose of the waiting time is to allow the extruder to melt the printed surfaces before extruding, thereby facilitating the adhesion of the material being extruded to the material that has already solidified.
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.46\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/detalle_punta_2.svg.pdf}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.35\textwidth}
        \centering
        \\includegraphics[width = \textwidth]{imgs/detalle_punta_sol_2.svg.pdf}
     \end{subfigure}
     \caption{Pyramids with deformations at their upper vertices due to the extruder colliding at the intersection points of the edges.}
    \label{fig:sol1}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.43\textwidth}
        \centering
        \\includegraphics[width =\textwidth]{imgs/P3_1.svg.pdf}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \\includegraphics[width = \textwidth]{imgs/P3_2.svg.pdf}
     \end{subfigure}
     \caption{Pyramids with deformations at their upper vertices due to the extruder colliding at the intersection points of the edges.}
    \label{fig:sol2}
\end{figure}

\subsection{Non-planar printing of the first layer of tetrahedra}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width= 0.6\textwidth]{imgs/first_layer.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \\includegraphics[width= 0.6\textwidth]{imgs/detail_base_adhesion.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \\includegraphics[width = \textwidth]{imgs/prob2_1.svg.pdf}
     \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \\includegraphics[width =\textwidth]{imgs/prob2_2.svg.pdf}
     \end{subfigure}
     \begin{subfigure}[b]{0.3\textwidth}
        \\includegraphics[width =\textwidth]{imgs/prob2_3.svg.pdf}
     \end{subfigure}
...
After implementing this latest solution, another problem was observed that illustrated an intrinsic problem with the extruder. 
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \\includegraphics[width = \textwidth]{imgs/blob_1.svg.pdf}
     \end{subfigure}
    \begin{subfigure}[b]{0.445\textwidth}
        \\includegraphics[width =\textwidth]{imgs/blob_2.svg.pdf}
     \end{subfigure}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.42\textwidth}
        \\includegraphics[width = \textwidth]{imgs/prob3_1.svg.pdf}
        \caption{Example of material overextrusion}
     \end{subfigure}
    \begin{subfigure}[b]{0.51\textwidth}
        \\includegraphics[width =\textwidth]{imgs/prob3_2.svg.pdf}
...
\begin{figure}[!htbp]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \\includegraphics[width = \textwidth]{imgs/hotfil_1.svg.pdf}
        \caption{Roughness present on the filament after 10 minutes of extrusion.}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[b]{0.3\textwidth}
        \\includegraphics[width =\textwidth]{imgs/hotfil_2.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[t]{0.47\textwidth}
        \\includegraphics[width = \textwidth]{imgs/hotfil_5.svg.pdf}
        \caption{Comparison of extruded filament without adapter (left) and with adapter (right).}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[t]{0.415\textwidth}
        \\includegraphics[width =\textwidth]{imgs/hotfil_6.svg.pdf}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[t]{0.35\textwidth}
        \\includegraphics[width = \textwidth]{imgs/sec_2.svg.pdf}
        \caption{Conventional assembly.}
     \end{subfigure}
     \hspace{1cm}
    \begin{subfigure}[t]{0.4\textwidth}
        \\includegraphics[width =\textwidth]{imgs/sec_1.svg.pdf}
